...
from mystic.cooldown import CooldownError
from mystic.data.igloo import Flooring, Furniture, Igloo, Location
from mystic.data.item import Item
from mystic.data.permission import Permission
from mystic.data.pet import PenguinPuffle, Puffle
from mystic.data.room import Room
from mystic.data.stamp import Stamp
...
class RoomConverter(IConverter):
    ...
    description = """Converts a room ID into a mystic.data.Room instance"""
...
class ItemConverter(IConverter):
    ...
    description = """Converts an item ID into a mystic.data.Item instance"""
...
class IglooConverter(IConverter):
    ...
    description = """Converts an igloo ID into a mystic.data.Igloo instance"""
...
class FurnitureConverter(IConverter):
    ...
    description = """Converts a furniture ID into a mystic.data.Furniture instance"""
...
class FlooringConverter(IConverter):
    ...
    description = """Converts a flooring ID into a mystic.data.Flooring instance"""
...
class LocationConverter(IConverter):
    ...
    description = """Converts a location ID into a mystic.data.Location instance"""
...
class StampConverter(IConverter):
    ...
    description = """Converts a stamp ID into a mystic.data.Stamp instance"""
...
class PuffleConverter(IConverter):
    ...
    description = """Converts a puffle ID into a mystic.data.Puffle instance"""
...
class PenguinPuffleConverter(IConverter):
    ...
    description = """Converts a penguin puffle ID into a mystic.data.PenguinPuffle instance"""
...
class PermissionConverter(IConverter):
    ...
    description = """Converts a permission identifier to a mystic.data.Permission instance"""
