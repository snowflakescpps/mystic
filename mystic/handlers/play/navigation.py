...
from mystic.constants import ClientType, StatusField
from mystic.data import db
from mystic.data.penguin import Login, Penguin
from mystic.data.room import PenguinBackyardRoom, PenguinIglooRoom, Room, RoomCollection, RoomTable, RoomWaddle
from mystic.handlers import XTPacket
from mystic.handlers.games.four import ConnectFourLogic
from mystic.handlers.games.mancala import MancalaLogic
from mystic.handlers.games.ninja.card import CardJitsuLogic, CardJitsuMatLogic, SenseiLogic
from mystic.handlers.games.ninja.fire import CardJitsuFireLogic, FireMatLogic, FireSenseiLogic
from mystic.handlers.games.ninja.water import CardJitsuWaterLogic, WaterSenseiLogic
from mystic.handlers.games.sled import SledRacingLogic
from mystic.handlers.games.treasure import TreasureHuntLogic
...
async def handle_join_server(p, penguin_id: int, login_key: str):
    ...
    server_key = f'mystic.players.{p.server.config.id}'
    await p.server.redis.sadd(server_key, p.id)
    await p.server.redis.hset('mystic.population', p.server.config.id, len(p.server.penguins_by_id))
