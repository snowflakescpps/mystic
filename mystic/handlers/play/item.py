...
from mystic.data.item import Item, ItemCollection, PenguinItemCollection
from mystic.data.permission import PenguinPermissionCollection
from mystic.data.plugin import PenguinAttributeCollection
