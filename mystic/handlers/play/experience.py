...
from mystic.data.quest import PenguinQuestTask, Quest, QuestAwardFurniture, QuestAwardItem, QuestAwardPuffleItem, \
    QuestTask
from mystic.handlers import XTPacket
from mystic.handlers.play.navigation import handle_join_player_room, handle_join_room, handle_join_server
